# aumentar base e distancia entre as torres
...
base.place(x=50,y=350,width="1000",height="30")
...
disco1 = Label(app,background = "#ff0",foreground ="#000")
#disco1.place(x=117,y=170,width="75",height="30")

disco2 = Label(app,background = "#f23",foreground ="#000")
#disco2.place(x=103,y=200,width="105",height="30")

disco3 = Label(app,background = "#103",foreground ="#000")
#disco3.place(x=89,y=230,width="135",height="30")

disco4 = Label(app,background = "#080",foreground ="#000")
#disco4.place(x=75,y=260,width="165",height="30")

disco5 = Label(app,background = "#ff007f",foreground ="#000")
#disco5.place(x=61,y=290,width="195",height="30")

disco6 = Label(app,background = "#0000ff",foreground ="#000")
...
total = int(input("escreva: "))
UIInicializarDiscos(total)
...
def UIMoverDisco(disco,torreEscolha,altura):
    if disco == 1:
        disco1.place(x= (117+((torreEscolha - 1)*400)) , y=  170 + (30* altura) ,width="75",height="30")
   
    elif disco == 2:
        disco2.place(x=103+(((torreEscolha - 1)*400)),y=200 + (30* altura) ,width="105",height="30")

    elif disco == 3:
        disco3.place(x=89 +(((torreEscolha - 1)*400)),y=230 + (30* altura) ,width="135",height="30")

    elif disco == 4:
        disco4.place(x=75 +(((torreEscolha - 1)*400)),y=260 + (30* altura),width="165",height="30")

    elif disco == 5:
        disco5.place(x=61 +(((torreEscolha - 1)*400)),y=290 + (30* altura),width="195",height="30")

    elif disco == 6:
        disco6.place(x=47 +(((torreEscolha - 1)*400)),y=320 + (30* altura),width="225",height="30")
